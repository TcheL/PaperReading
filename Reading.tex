...
\fancyfoot[L]{\thepage{}}
\fancyfoot[R]{\hyperref[toc]{$\circlearrowright$}}
% -------------------------------------
...
% \usepackage{mathptmx}                             % Times New Roman font package for formula
% no difference between normal and bold Greek characters
...
\makeatletter
\newcommand{\mybox}[1]{\textcolor{green}{\tikz[baseline={([yshift=-3pt]current bounding box.center)}] \node [rectangle, minimum width=1ex,rounded corners,draw] {\normalcolor\m@th$\displaystyle#1$};}}
\makeatother
