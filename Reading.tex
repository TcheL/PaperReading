...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{$\xleftswishingghost{\hyperref[sec:\exprsum{-1}{\thesection}]{\sf Prev}}$}
\fancyhead[C]{\textsc{\pmk}}
\fancyhead[R]{$\xrightswishingghost{\hyperref[sec:\exprsum{+1}{\thesection}]{\sf Next}}$}
\fancyfoot[L]{\thepage{}}
\fancyfoot[R]{\hyperref[sec:0]{$\circlearrowleft$}}
% -------------------------------------
...
% \let\iiiint\relax
% \let\idotsint\relax
\usepackage{newtxmath}                            % faked Times font package for formula, no difference between normal and bold characters
\let\Bbbk\relax
% \usepackage[noendash]{mathastext}                 % deal math same as text package
...
\usepackage[colorlinks, breaklinks, linkcolor=blue, anchorcolor=yellow, citecolor=green]{hyperref}      % hyperreference package
...
\usepackage{makeidx}
\usepackage{halloweenmath}                        % symbol package for \xleftswishingghost and \xrightswishingghost commands
\usepackage{pifont}                               % symbol package for \ding command

\renewcommand{\part}[1]{{\LARGE\bf\noindent #1}}
\newcommand{\myleftmark}{\textsc{\pmk}} %\MakeUppercase{\pmk}}
...
\newcommand{\pinfo}{\refp{\pmk}\footnote{\pay,~\pjo,~\pti.~Date:~\pda}\label{sec:\thesection}}
\newcommand{\sline}{*************************}
...
\input{FWI/Pratt_1998_GJI_Newton}
\vspace{5mm}
...
\input{FWI/LiuQY_2006_BSSA_Finite-frequency}
\vspace{5mm}

\input{FWI/Tape_2007_GJI_Adjoint}
\vspace{5mm}

\input{FWI/Bozdag_2011_GJI_Misfit}
\vspace{5mm}
...
% \input{FWI/Virieux_2009_Geophy_OverviewFWI}
% \vspace{5mm}

\input{FWI/YangPL_2015_Geophy_GPUFWI}
\vspace{5mm}

\input{FWI/Krebs_2009_Geophy_FFW}
\vspace{5mm}

\input{FWI/Bleibinhaus_2009_Geophy_Surface}
\vspace{5mm}

\input{FWI/Bunks_1995_Geophy_Multiscale}
\vspace{5mm}

\input{FWI/Tromp_2019_GJI_Source}
\vspace{5mm}

\input{FWI/YuanYH_2016_GJI_Double-difference}
\vspace{5mm}

\input{FWI/PanYD_2020_GJI_Multi-objective}
\vspace{5mm}

% ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

\npart
\part{Wavefield Forward Modelling}

\input{Modelling/ZhangW_2006_GJI_Traction}
\vspace{5mm}

\input{Modelling/ZhangW_2010_Geophy_ADE}
\vspace{5mm}

% ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

\npart
\part{General Inversion}

\input{Inversion/Gallovic_2019_JGRse_Bayesian}
\vspace{5mm}

\input{Inversion/Schraudolph_2007_AIStat_Stochastic}
\vspace{5mm}
...
\input{Others/SunWJ_2013_CG_Reduce}
\vspace{5mm}

\input{Others/Kennett_2016_GGG_Multiscale}
\vspace{5mm}

\input{Others/Nihei_2007_GJI_TDPSD}
\vspace{5mm}

\input{Others/Belouchrani_1998_IEEEtsp_Blind}
\vspace{5mm}
