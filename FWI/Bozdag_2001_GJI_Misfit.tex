...
\begin{enumerate}[\hspace{10mm}*]
  ...
  \item \myem{Automated phase-picking algorithms}:
    \myidx{Other}{Method}{automated phase-picking}
    Maggi \etal, 2009.
  ...
  \item 3-D mantle model \mynno{S20RTS}:
    \myidx{Other}{Model}{S20RTS: 3-D mantle}
    Ritsema \etal, 1999.
...
\myidx{Other}{Method}{Hilbert transform}
...
\myidx{Other}{Discussion}{advantage and drawback of different measurements}
