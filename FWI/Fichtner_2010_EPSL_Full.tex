...
\begin{enumerate}[\hspace{10mm}*]
  ...
  \item \mynnem{crust2.0 model}
    \myidxox{Other}{Model}{crust2.0: 3-D crust}:
  ...
  \item Minimise the cumulative phase misfit using a preconditioned conjugate-gradient method:
    Fichtner \etal, 2009b.
  \item \mynem{The adjoint method}: Tarantola, 1988; Tromp \etal, 2005; Fichtner \etal, 2006;
  ...
  \item \mynnem{AK135 model}
    \myidxox{Other}{Model}{AK135: 1-D}:
    Kennett \etal, 1995.
  ...
  \item \mynem{The Lehmann discontinuity}: Lehmann, 1961; Karato, 1992.
