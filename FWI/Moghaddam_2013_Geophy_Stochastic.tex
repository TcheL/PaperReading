...
where $k$ the iteration number, $\eta_k$ the step length, $J$ the misfit function, $\sigma_k$ the model at iteration $k$ and \mynem{$\mbf w_k$ the current randomized weight}.\par
